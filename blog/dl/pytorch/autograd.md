...
![正向计算](https://cdn.jsdelivr.net/npm/lblbk-picgo@latest/work/20210203142015.png)
...
![](https://cdn.jsdelivr.net/npm/lblbk-picgo@latest/work/20210203142033.png)
...
所以 $\frac{\partial loss}{\partial w_{3}}=\frac{\partial loss}{\partial l_{4}} \frac{\partial l_{4}}{\partial l_{3}} \frac{\partial l_{3}}{\partial w_{3}}=[2.5, 2.5, 2.5, 2.5]$
